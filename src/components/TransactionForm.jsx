        ...
        <div className="bg-white p-4 md:p-8 rounded-2xl shadow-soft border border-gray-100 relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6">
                    ...
                    <div className="group lg:col-span-1">
                        <label className="text-[10px] md:text-xs text-text-muted font-bold mb-1.5 md:mb-2 block uppercase tracking-wider transition-colors">Montant du pourcentage</label>
                        <input
                            type="text"
                            value={formatMoney(fee, activeCurrency)}
                            className="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-3 md:px-4 md:py-3.5 text-sm md:text-base text-accent-primary font-bold appearance-none min-h-[46px] md:min-h-[52px] focus:outline-none cursor-default"
                            readOnly
                            tabIndex="-1"
                        />
                    </div>
